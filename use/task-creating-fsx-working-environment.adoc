...
.步骤
. 在BlueXP中、添加一个新的工作环境、选择* Amazon Web Services*、然后单击*为适用于ONTAP 的Amazon FSX添加新*。
+
...
. *数据加密*
+
接受默认 AWS 主密钥或单击 * 更改密钥 * 以选择其他 AWS 客户主密钥（ CMK ）。有关 CMK 的详细信息，请参见 https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/https://docs.netapp.com/us-en/occm/task-setting-up-kms.html["设置 AWS KMS"^]。
...
.关于此任务
您可以通过发现适用于ONTAP 文件系统的FSx link:/task-creating-fsx-working-environment.html#create-an-amazon-fsx-for-ontap-working-environment["创建新的工作环境"] 或者使用*我的商机*页面。此任务介绍如何使用*我的商机*进行发现
