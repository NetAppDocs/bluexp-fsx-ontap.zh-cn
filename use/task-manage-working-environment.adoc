...
summary: 您可以通过Cloud Manager管理适用于ONTAP 的FSX工作环境。您可以更改吞吐量和存储容量以及IOPS、并删除或删除工作环境。 
---
...
[role="lead"]
您可以通过Cloud Manager管理适用于ONTAP 的FSX工作环境。您可以更改吞吐量和存储容量以及IOPS、并删除或删除工作环境。
...
. 选择*删除*以从Cloud Manager中删除适用于ONTAP 的FSx。
